...
namespace Plant.Core
{
    ...
    public class BasePlant
    {
        ...
        public IEnumerable<T> CreateListOf<T>(int numberOfInstances, object userSpecifiedProperties = null, string variation = null, bool created = true)
        {
            return Enumerable.Range(0, numberOfInstances)
                             .Select(i => Create<T>(userSpecifiedProperties, variation, created));
        }

        public IEnumerable<T> BuildListOf<T>(int numberOfInstances, T userSpecifiedProperties)
        {
            return Enumerable.Range(0, numberOfInstances)
